...
function goToPaymentPage(priceId) {
  ...
  if (priceId === 'pro') {
    document.querySelector('#submit-pro-button-text').innerText =
      'Selected';
    document.querySelector('#submit-free-button-text').innerText = 'Select';
  } else {
    document.querySelector('#submit-pro-button-text').innerText = 'Select';
    document.querySelector('#submit-free-button-text').innerText = 'Selected';
  }
...
function createCustomer() {
  let billingEmail = 'chethan.sindhie@narvar.com';//document.querySelector('#email').value;
...
function demoChangePrice() {
  document.querySelector('#free').classList.remove('border-pasha');
  document.querySelector('#pro').classList.remove('border-pasha');
  document.querySelector('#price-change-form').classList.add('hidden');
  ...
  if (priceId === 'pro') {
    document.getElementById('submit-pro').disabled = true;
    document.getElementById('submit-free').disabled = false;
  } else {
    document.getElementById('submit-pro').disabled = false;
...
function changeLoadingStateprices(isLoading) {
  if (isLoading) {
    ...
    document.querySelector('#submit-free').classList.add('invisible');
    document.querySelector('#submit-pro').classList.add('invisible');
    ...
    document.querySelector('#submit-free').classList.remove('invisible');
    document.querySelector('#submit-pro').classList.remove('invisible');
    if (document.getElementById('confirm-price-change-cancel')) {
      document
        .getElementById('confirm-price-change-cancel')
